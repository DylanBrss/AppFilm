...
export default {
    ...
    created() {
        axios
            ...
            axios
                .get("https://api.themoviedb.org/3/discover/movie?api_key=8d2265a50d4907bf6dd28e4ad308b47e&language=fr&include_adult=false&vote_average.gte=8&vote_count.gte=1000&page=2")
            ...
            axios
                .get("https://api.themoviedb.org/3/discover/movie?api_key=8d2265a50d4907bf6dd28e4ad308b47e&language=fr&include_adult=false&vote_average.gte=8&vote_count.gte=1000&page=3")
