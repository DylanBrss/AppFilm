// //on import createStore et on initialise le store
...
export const store = createStore({
    state() {
        ...
        // sinon : state par défaut (avec variable vides)
    ...
    mutations: {
        // stocker les films les plus populiares dans le state
        storePopulaireMovies(state, payload) {
        ...
        // stocker les dermiers films dans le state
